...
AddPrefabPostInit("world", function(inst)
	...
	UpvalueHacker.SetUpvalue(GLOBAL.Prefabs.player_classified.fn, function(inst) if inst.fadetime:value() <= 0 then GLOBAL.TheCamera:Snap() end end, "RegisterNetListeners", "OnPlayerFadeDirty")
